            ...
            <nav class="bg-white px-2 sm:px-4 py-2.5 static w-full z-20 top-0 left-0 border-gray-200 shadow-md rounded-md">
                <div class="container flex flex-wrap justify-between items-center mx-auto">
                    ...
                    <div class="flex md:order-2">
                        ...
                        <button type="button" class="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-0 md:mr-0 invisible lg:visible">LOGOUT</button>
